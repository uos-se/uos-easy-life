...
public class CoursePlannerTest {
    ...
    static Stream<Arguments> planCoursesTestSource() {
        ...
        // 별도로 1학년 1학기에는 공학도의창업과경영 과목을 추가
        List<String> recommendedCourseIds1by1 = new ArrayList<>(recommendedCourseIds);
        recommendedCourseIds1by1
                .add(courseRepository.findByNameAndDepartment("공학도의창업과경영", Department.GeneralEducation).getId());
