...
졸업해줘는 복잡한 학교 학사 정보 시스템의 접근성을 개선하여 학생들이 필요한 정보를 더 쉽게 찾고 이용할 수 있도록 돕는 통합 시스템입니다. 이 프로젝트는 백엔드로 Spring Boot, 프론트엔드로 React를 사용하여 개발되었으며, 학생들에게 직관적인 사용자 경험을 제공하고 신속한 데이터 접근이 가능하도록 설계되었습니다.
